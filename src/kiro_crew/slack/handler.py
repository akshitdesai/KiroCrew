...
def _is_sessions_keyword(text: str) -> bool:
    ...
    fall-through in ``maybe_route_linked_thread`` — widening any keyword
    branch without this helper would silently re-open #10865, because the
    linked-thread intercept copy would stop matching what the branches match.
    """
