...
describe('GitPanel repository state', () => {
  it('renders a terminal no-repository state without claiming the tree is clean', async () => {
    ...
    expect(screen.getByText(
      'This project folder is not a Git repository. If the repository is in a subfolder, select that subfolder with the Project directory picker.',
    )).toBeInTheDocument()
  ...
  it('does not render stale clean data beside a failed refresh', async () => {
