          ...
          <dl className="text-xs space-y-2">
            ...
            <div className="flex gap-2">
              ...
              <dd className="min-w-0 truncate" data-testid="member-config-provenance">
                ...
                {/* The agent id is quoted in the sentence (it reads as prose
                    otherwise: "Template triage from Oncall pack" beside members
                    also named triage), and the version parenthetical is dropped
                    rather than printed as "(v?)" when the row records none. */}
                {active.template
                  ? t(
          ...
          {!active.is_default && (
            <FirePanel
              ...
              onFired={(result) => {
                ...
                firedNameRef.current = active.name
                setFiredNotice({
