...
function ContentResults({ query, projectDir, onOpen }: {
  ...
  // actively misleading: "python" reads as a claim that the search was narrowed
  // to Python FILES -- that the list is incomplete on purpose. It lives in the
  // row's tooltip, where the same string answers "why is this slow" without
  // being mistaken for a filter. The tooltip also says what a partial answer
